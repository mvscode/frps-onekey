...
program_version_link="https://github.com/Jacko1045/frp-onekey/tree/Jacko1045-frp-test/version.sh"
str_install_shell="https://github.com/Jacko1045/frp-onekey/tree/Jacko1045-frp-test/install-frps.sh"
shell_update(){
    fun_clangcn "clear"
